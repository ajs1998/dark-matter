...
export const yellow60 = '#8e6a00'; // 3.31
export const yellow70 = '#684e00'; // 2.10
export const yellow80 = '#483700'; // 1.43
export const yellow90 = '#302400'; // 1.08
export const yellow100 = '#1c1500'; // 1.10
export const yellow = {
    10: yellow10,
    20: yellow20,
    30: yellow30,
...
export const yellow50Hover = '#9e7700'; // 4.00
export const yellow60Hover = '#755800'; // 2.47
export const yellow70Hover = '#806000'; // 2.82
export const yellow80Hover = '#5c4600'; // 1.83
export const yellow90Hover = '#3d2e00'; // 1.25
export const yellow100Hover = '#332600'; // 1.11
...
export const orange60 = '#ba4e00'; // 3.28
export const orange70 = '#8a3800'; // 2.08
...
export const orange50Hover = '#cc5500'; // 3.82
export const orange60Hover = '#9e4200'; // 2.54
export const orange70Hover = '#a84400'; // 2.74
...
export const red60 = '#da1e28'; // 3.29
export const red70 = '#a2191f'; // 2.11
export const red80 = '#750e13';
export const red90 = '#520408';
export const red100 = '#2d0709';
export const red = {
    10: red10, 20: red20, 30: red30, 40: red40, 50: red50, 60: red60, 70: red70, 80: red80, 90: red90, 100: red100,
};

export const red100Hover = '#540d11'; // 1.13
export const red90Hover = '#66050a'; // 1.25
export const red80Hover = '#921118'; // 1.82
export const red70Hover = '#c21e25'; // 2.75
export const red60Hover = '#b81922'; // 2.51
export const red50Hover = '#ee0713'; // 3.67
...
export const magenta60 = '#d02670'; // 3.29
export const magenta70 = '#9f1853'; // 2.14
...
export const magenta70Hover = '#bf1d63'; // 2.80
export const magenta60Hover = '#b0215f'; // 2.53
export const magenta50Hover = '#e3176f'; // 3.62
...
export const purple60 = '#8a3ffc'; // 3.29
export const purple70 = '#6929c4'; // 2.13
...
export const purple70Hover = '#7c3dd6'; // 2.74
export const purple60Hover = '#7822fb'; // 2.68
export const purple50Hover = '#9352ff'; // 3.84
...
export const blue60 = '#0f62fe'; // 3.29
export const blue70 = '#0043ce'; // 2.11
...
export const blue70Hover = '#0053ff'; // 2.89
export const blue60Hover = '#0050e6'; // 2.58
export const blue50Hover = '#1f70ff'; // 3.78
...
export const cyan60 = '#0072c3'; // 3.29
export const cyan70 = '#00539a'; // 2.12
...
export const cyan50Hover = '#0f7ec8'; // 3.80
export const cyan60Hover = '#005fa3'; // 2.48
export const cyan70Hover = '#0066bd'; // 2.85
...
export const teal60 = '#007d79'; // 3.30
export const teal70 = '#005d5d'; // 2.14
...
export const teal50Hover = '#008a87'; // 3.91
export const teal60Hover = '#006b68'; // 2.59
export const teal70Hover = '#007070'; // 2.79
...
export const green60 = '#198038'; // 3.29
export const green70 = '#0e6027'; // 2.14
...
export const green50Hover = '#208e3f'; // 3.93
export const green60Hover = '#166f31'; // 2.63
export const green70Hover = '#11742f'; // 2.80
...
export const coolGray60 = '#697077'; // 3.28
export const coolGray70 = '#4d5358'; // 2.11
...
export const coolGray50Hover = '#757b85'; // 3.87
export const coolGray60Hover = '#585e64'; // 2.51
export const coolGray70Hover = '#5d646a'; // 2.74
...
export const gray60 = '#6f6f6f'; // 3.28
export const gray70 = '#525252'; // 2.11
...
export const gray50Hover = '#7a7a7a'; // 3.84
export const gray60Hover = '#5e5e5e'; // 2.54
export const gray70Hover = '#636363'; // 2.74
...
export const warmGray60 = '#726e6e'; // 3.27
export const warmGray70 = '#565151'; // 2.11
...
export const warmGray50Hover = '#7f7b7b'; // 3.94
export const warmGray60Hover = '#605d5d'; // 2.53
export const warmGray70Hover = '#696363'; // 2.80
...
export const colors = {
    black: {
        100: black100,
    }, blue, coolGray, cyan, gray, green, magenta, orange, purple, red, teal, warmGray, white: {
        0: white0,
    }, yellow,
};
